...
It seems like the 7 $\upmu$m microelectrode diameter is small enough that the small convective effect is alleviated by diffusion to such an extent, that the reaction behaves as if the microelectrode wasn't there.
...
\begin{table}
\caption{Chemical wave encounters by the microelectrode.}
\label{table:stats}
\centering
\begin{tabular}{r c c c c}
 Wave\# & t, s & E, V & x, $\upmu$m & v, $\upmu$m/s \\
 \hline
 \hline
 3&\begin{tabular}{c}47\\67\\80\end{tabular}&\begin{tabular}{c}0.957\\0.978\\0.977\end{tabular}&\begin{tabular}{c}1400\\6400\\6800\end{tabular}&218.18\\
 \hline
 6&\begin{tabular}{c}99\\114\\133.5\end{tabular}&\begin{tabular}{c}0.968\\0.975\\1.027\end{tabular}&\begin{tabular}{c}1000\\4800\\7600\end{tabular}&191.3\\
 \hline
 7&\begin{tabular}{c}148.5\\171\\181.5\end{tabular}&\begin{tabular}{c}1.052\\1.127\\1.059\end{tabular}&\begin{tabular}{c}1600\\7200\\8800\end{tabular}&218.18\\
 \hline
 9&\begin{tabular}{c}200\\219.5\\234.5\end{tabular}&\begin{tabular}{c}1.016\\1.074\\1.016\end{tabular}&\begin{tabular}{c}1400\\6200\\8000\end{tabular}&191.3\\
 \hline
 12&\begin{tabular}{c}253.5\\268\\287\end{tabular}&\begin{tabular}{c}1.060\\1.120\\1.053\end{tabular}&\begin{tabular}{c}400\\5200\\7400\end{tabular}&208.96\\
\end{tabular}
\end{table}
...
%  \end{axis}
%\end{tikzpicture}
\caption{Electrochemical space-time plot overlayed on top of the corresponding optical one.
...
Compared to the optical methods, it allowed far more reaching conclusions to be made by several research groups.
