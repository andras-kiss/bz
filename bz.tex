...
\begin{tikzpicture}
  ...
  \end{axis}
\end{tikzpicture}
\caption{(A) Electrochemical space-time plot overlayed on top of an optical one.
The potential of the carbon fiber microelectrode is shown as a function of spatiotemporal coordinates.
(a)--(b) Instances in time at (a) t = 0 s (before the first scan cycle), (b) t = 51 s (after the first scan cycle), (c) t = 102 s (after the second scan cycle), (d) t = 153 s (after the third scan cycle).
...
(a)--(b): same instances in time as in Fig. \ref{fig:spatiotemporal}.
